...
[![Build Status](https://travis-ci.org/jchiavaro/swagger-demo.svg?branch=master)](https://travis-ci.org/jchiavaro/swagger-demo)
...
6. If you did everything correct, https://jchiavaro.github.io/swagger-demo/ will lead to your new docs
...
- Documentation(ReDoc): https://jchiavaro.github.io/swagger-demo/
- SwaggerUI: https://jchiavaro.github.io/swagger-demo/swagger-ui/
- Look full spec:
    + JSON https://jchiavaro.github.io/swagger-demo/swagger.json
    + YAML https://jchiavaro.github.io/swagger-demo/swagger.yaml
- Preview spec version for branch `[branch]`: https://jchiavaro.github.io/swagger-demo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://jchiavaro.github.io/swagger-demo/ with url from the message: `Server started <url>`
